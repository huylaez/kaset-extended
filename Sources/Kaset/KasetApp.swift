...
struct KasetApp: App {
    ...
    init() {
        ...
        _sleepTimerService = State(initialValue: sleepTimer)
    ...
    var body: some Scene {
        Window("Kaset", id: "main") {
            ...
            if UITestConfig.isRunningUnitTests, !UITestConfig.isUITestMode {
                ...
                .preferredColorScheme(self.settings.appAppearance.colorScheme)
                ...
                .environment(self.sleepTimerService)
    ...
    private func handleYouTubeSurfaceLocationChange(_ location: YouTubePlayerService.SurfaceLocation) {
        ...
        if location == .floating {
            YouTubeVideoWindowController.shared.show(
                ...
                sleepTimerService: self.sleepTimerService
            )
        } else {
